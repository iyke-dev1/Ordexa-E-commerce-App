...
class MyTextTheme {
  ...
  static TextTheme lightTexTheme = TextTheme(
    ...
    titleLarge: TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w600,color: Colors.black),
    ...
    labelMedium:TextStyle().copyWith(fontSize: 10,fontWeight: FontWeight.normal,color: Colors.black),
    labelSmall:TextStyle().copyWith(fontSize: 8,fontWeight: FontWeight.normal,color: Colors.black.withAlpha(80)),
  );
  ...
  static TextTheme darkTexTheme = TextTheme(
    ...
    titleLarge: TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w600,color: Colors.white),
    ...
    labelMedium:TextStyle().copyWith(fontSize: 10,fontWeight: FontWeight.normal,color: Colors.white),
    labelSmall:TextStyle().copyWith(fontSize: 8,fontWeight: FontWeight.normal,color: Colors.white.withAlpha(80)),
